...
extends Interfaces.PartialHelmholtzMedium(
  ...
  helmholtzCoefficientsButane(
    ...
    residualBwr=[
     ...
     residualGauss=[
       0.17534618E-01,  0.76,  1.,  2., 2.,  -0.963,    -2.33,  0.684,  1.283,  0., 0., 0.;
       0.33874242E+00,  2.50,  1.,  2., 2.,  -1.977,    -3.47,  0.829,  0.6936, 0., 0., 0.;
       0.22228777E+00,  2.75,  1.,  2., 2.,  -1.917,    -3.15,  1.419,  0.788,  0., 0., 0.;
      -0.23219062E+00,  3.05,  2.,  2., 2.,  -2.307,    -3.19,  0.817,  0.473,  0., 0., 0.;
      -0.92206940E-01,  2.55,  2.,  2., 2.,  -2.546,    -0.92,  1.500,  0.8577, 0., 0., 0.;
      -0.47575718E+00,  8.40,  4.,  2., 2.,  -3.28,     -18.8,  1.426,  0.271,  0., 0., 0.;
      -0.17486824E-01,  6.75,  1.,  2., 2.,  -14.6,     -547.8, 1.093,  0.948,  0., 0., 0.])
  ...
  thermalConductivityCoefficientsButane(
    ...
    lambda_0_coeffs=[
      -1.24778E-3,    0;
       8.16371E-3,    1;
       1.99374E-2,    2],
    reducingTemperature_residual=369.85,
