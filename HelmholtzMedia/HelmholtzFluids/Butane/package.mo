...
extends Interfaces.PartialHelmholtzMedium(
  ...
  fluidConstantsButane(
    ...
    hasCriticalData=true,
       ...
       HCRIT0=693906.46832645,
       SCRIT0=2363.08708799709,
  ...
  helmholtzCoefficientsButane(
    ...
    residualPoly=[
      +0.25536998241635E+01,    0.5,    1.;
      -0.44585951806696E+01,    1.0,    1.;
      +0.82425886369063E+00,    1.5,    1.;
      +0.11215007011442E+00,    0.0,    2.;
      -0.35910933680333E-01,    0.5,    3.;
      +0.16790508518103E-01,    0.5,    4.;
      +0.32734072508724E-01,    0.75,   4.],
    residualBwr=[
  ...
  thermalConductivityCoefficientsButane(
    ...
    lambda_0_num_coeffs=[
     ...
     9.75703E-04,    1;
     2.89887E-02,    2],
    reducingTemperature_background=425.16,
    reducingMolarVolume_background=1/3920,
