...
%
% warning: simplifying the nonAnalyticalTerms will keep MatLab busy for a
% while
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
syms ni1 ni2 ni3 ni4 ni5 ni6 ni7 ni8 ni9 ni10 ni11 ni12;
...
nonAnalyticalTerms = ni1*Distance^ni6*delta*exp(-ni9*(delta-1)^2-ni10*(tau-1)^2);
